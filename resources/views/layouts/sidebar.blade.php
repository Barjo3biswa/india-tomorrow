    ...
    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('admin.create-news-section') ? 'active' : '' }}" href="{{route('admin.create-news-section')}}">
                ...
                <span class="nav-link-text">Add News Section</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('admin.advertisement') ? 'active' : '' }}" href="{{route('admin.advertisement')}}">
                <span class="nav-icon">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <span class="nav-link-text">Advertisement</span>
            </a>
        </li>
